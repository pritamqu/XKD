...
from engine.video.video_linear import finetune as worker
...
def get_args():
    ...
    ## dataset and config
    parser.add_argument("--db", default="ssv2", help="target db", choices=['ucf101', 'hmdb51', 'kinetics400', 'ssv2', 'charades'])  
    parser.add_argument('-c', '--config-file', type=str, help="pass config file name w/o extension", 
                        default="ssv2_2g_linear_32x112_16x4_strong_adamw_v5")
