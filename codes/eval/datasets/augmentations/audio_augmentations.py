...
_KINETICS = [-5.3688107,  4.410007 ]
_FSD50K = [-10.501877,    5.3142986] # WAV files
_ESC50 = [-7.28733  ,  5.1870246]
_OPENMIC = [-4.718143 ,  4.2610707]
...
class StrongAug(object):
    ...
    def __init__(self, 
        ...
        DB_NORM = eval(DB_NORM)
        self.mode = mode
        self.mean, self.std = DB_NORM[0], DB_NORM[1]
