    ...
    if name=='kinetics400':
        return Kinetics(
            DATA_PATH = os.path.join(root),
                  ...
                  audio_fps_out= dataset_kwargs['audio_fps_out'] if 'audio_fps_out' in dataset_kwargs else dataset_kwargs['audio_fps'], # when extracting raw waveforms
                  ...
                  # submode=dataset_kwargs[split]['submode'] if 'submode' in dataset_kwargs[split] else None,
